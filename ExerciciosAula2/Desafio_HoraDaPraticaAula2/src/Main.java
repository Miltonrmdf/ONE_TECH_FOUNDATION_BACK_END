...
Faça o casting da variável double para int e imprima o resultado.*/
        ...
        String ex6= """
                ...
                e atribua um valor percentual de desconto ao produto 
        ...
        double precoOriginal=258.63;
        double percentualDesconto=15.0;
        double valorDoDesconto=(percentualDesconto/100.0)*precoOriginal;
        double precoComDescont=precoOriginal-valorDoDesconto;

        System.out.println("O Preço original é R$"+precoOriginal);
        System.out.println("O Percentual de desconto é R$" + percentualDesconto);
        System.out.println("O preço com desconto é R$"+precoComDescont);
